...
import { computeAvailability, Suggestion } from "./utils/schedulerUtils";
...
> = ({ proposalId, onSelectSuggestion, onBack }) => {
  ...
  // Polling function to check for suggestions
  const pollForSuggestions = async (timeout: number = 10000) => {
    ...
    setIsLoadingSuggestions(false);
    console.log("Timeout: No suggestions found after polling.");
  };
